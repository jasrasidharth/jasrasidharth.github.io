  ...
  document.body.innerHTML = `
    ...
    <main class="main">
      ...
      <section class="section">
        ...
        <div class="summary-block">${d.summary}</div>
      </section>
      ...
      <section class="section">
        ...
        <div class="cert-list">
          ${d.certifications_header.map(c => `<span class="cert-tag">${c}</span>`).join("")}
        </div>
      </section>

      <!-- Core Competencies -->
      <section class="section">
        <h2 class="section-label">Core Leadership Competencies</h2>
        <div class="competencies-grid">
          ${d.competencies.map(c => `
            <div class="competency-card">
              <div class="competency-label">${c.label}</div>
              <div class="competency-value">${c.value}</div>
            </div>
          `).join("")}
        </div>
      </section>
